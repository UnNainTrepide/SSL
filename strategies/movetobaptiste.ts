...
/**
 * call "MSB.mtb" '{ "id_X_Y" : [[id,X,Y],[id,X,Y],...] }' (To try with npm run repl)
 * 
 * call "MSB.mtb" '{ "id_X_Y" : [[0,6,0],[1,1,0],[2,2.5,1],[3,2.5,-1],[4,4,1.5],[5,4,0.5]] }'
 * call "MSB.mtb" '{ "id_X_Y" : [[0,0,4],[1,0,3],[2,0,2],[3,0,1],[4,0,-1],[5,0,-2]] }'
 * call "MSB.mtb" '{ "id_X_Y" : [[0,0,4],[1,0,3],[2,0,2],[3,0,1],[4,0,-1],[5,0,-2]] }'
 */
export default class MoveToB extends Strategies {
  ...
  compute(broker: ServiceBroker): boolean {
    ...
    void broker.call('bots-control.moveTo', {
      id: this.id_X_Y[i][0],
      target: {x: this.id_X_Y[i][1], y: this.id_X_Y[i][2]},
      orientation: 0,
